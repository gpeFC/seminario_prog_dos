...
public class Neurona{
	...
	public void calcularSalida(int funcion, double[] entrada){
        if(funcion == 1)
            ...
            this.salida = Activacion.escalonBinario(ReglaPropagacion.sumaPonderada(this.bias, entrada, this.pesos));
        else if(funcion == 6)
            this.salida = Activacion.escalonBipolar(ReglaPropagacion.sumaPonderada(this.bias, entrada, this.pesos));
	}
}
