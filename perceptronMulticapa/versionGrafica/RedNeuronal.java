...
public class RedNeuronal{
	...
	public RedNeuronal(int numArgs, int numCapas, int[] numNeursCapa, String nombre, String topologia){
		CapaNeuronal capaNeuronal;
		this.nombre = nombre;
		if(topologia.equals("MULTICAPA"))
			this.funcion = "";
		else
			this.funcion = null;
	...
	public String obtenerFuncionRed(){
		return this.funcion;
	}

	public String obtenerTopologiaRed(){
	...
	public void establecerFuncionRed(String funcion){
